...
<div class="jumbotron" id="shopping" style="text-align:center">
	...
	<h3>Please make sure you have entered the title, year and director.</h3>
	<h3>And you must enter at least one name of the star and the genre of it.</h3>
	<h4><a href="dashAddMovie.jsp">Click me</a> to get back to update more movies.</h4>
	</div>
	</div>

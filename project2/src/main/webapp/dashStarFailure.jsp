...
<div class="jumbotron" id="shopping" style="text-align:center">
	...
	<h3>Maybe the star is existed so that you can not add him/her.</h3>
	<h3>Or maybe you entered the wrong format of date of birth.</h3>
